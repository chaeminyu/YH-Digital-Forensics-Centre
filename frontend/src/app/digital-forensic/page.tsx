...
const DigitalForensicPage: React.FC = () => {
  ...
  const subcategories = [
    ...
    { value: 'general-forensics', label: 'General Forensics', count: 0 },
    { value: 'evidence-forensics', label: 'Evidence Forensics', count: 0 },
    { value: 'digital-crime', label: 'Digital Crime', count: 0 }
  ]
        ...
        <Container>
          ...
          >
            ...
            <SectionHeading 
              ...
              subtitle="Professional digital investigation and forensic analysis services for legal and corporate clients"
              align="center"
            />
          </motion.div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                <div className="lg:col-span-3">
                  <div className="relative">
                    ...
                    <Input
                      type="text"
                      placeholder="Search digital forensic posts..."
                      value={searchQuery}
                ...
                <div>
                  <select
                    ...
                    className="w-full h-12 px-4 py-2 bg-slate-800 border border-slate-600 rounded-lg text-slate-200 focus:ring-2 focus:ring-accent-400 focus:border-transparent transition-colors"
                  >
          ...
          {loading ? (
            ...
            <Card className="p-12 text-center">
              ...
              <p className="text-slate-400 mb-6">
                {searchQuery ? 'Try adjusting your search query.' : 'No digital forensic posts have been published yet.'}
              </p>
            </Card>
          ) : (
          ...
          >
            <Card className="p-8 bg-gradient-to-br from-accent-500/10 to-primary-600/10 border-accent-500/20">
              ...
              <p className="text-slate-400 mb-6">
                Contact our expert team for comprehensive digital investigation and analysis services.
              </p>
