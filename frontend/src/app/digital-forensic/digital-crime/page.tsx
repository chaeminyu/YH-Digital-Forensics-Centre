...
const DigitalCrimePage: React.FC = () => {
  ...
  const fetchPosts = async () => {
    try {
      setLoading(true)
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/posts?category=digital-crime`)
      ...
      <Section className="pt-4">
        <Container>
          ...
          >
            ...
            <SectionHeading 
              title="Digital Crime"
              subtitle="Digital crime investigation and cybercrime analysis"
              align="center"
            />
          </motion.div>
          ...
          >
            <Card className="p-6">
              <div className="relative max-w-md mx-auto">
                ...
                <Input
                  type="text"
                  placeholder="Search digital crime posts..."
                  value={searchQuery}
          ...
          {loading ? (
            ...
            <Card className="p-12 text-center">
              ...
              <p className="text-slate-400 mb-6">
                {searchQuery ? 'Try adjusting your search query.' : 'No digital crime posts have been published yet.'}
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredPosts.map((post, index) => (
                ...
                >
                  <Link href={`/digital-forensic/digital-crime/${post.slug}`} className="block">
          ...
          >
            <Card className="p-8 bg-gradient-to-br from-accent-500/10 to-primary-600/10 border-accent-500/20">
              <h3 className="text-2xl font-bold text-slate-100 mb-4">
                Need Digital Crime Investigation?
              </h3>
              <p className="text-slate-400 mb-6">
                Contact our expert team for cybercrime investigation and digital crime analysis.
              </p>
...
export default DigitalCrimePage